...
public class WitchHatModel<T extends LivingEntity> extends AnimalModel<T> {
	...
	public WitchHatModel() {
		...
		headwear.setTextureOffset(0, 64).addCuboid(-10.0F, -0.1F, 0.0F, 10.0F, 2.0F, 10.0F, 0.0F, false);

		bone = new ModelPart(this);
		bone.setPivot(-8.5F, -0.1F, 1.5F);
		headwear.addChild(bone);
		setRotationAngle(bone, -0.0524F, 0.0F, 0.0349F);
		bone.setTextureOffset(0, 76).addCuboid(0.0F, -4.0F, 0.0F, 7.0F, 4.0F, 7.0F, 0.0F, false);

		bone2 = new ModelPart(this);
		bone2.setPivot(1.5F, -4.0F, 1.5F);
		bone.addChild(bone2);
		setRotationAngle(bone2, -0.1222F, 0.0F, 0.0698F);
		bone2.setTextureOffset(0, 87).addCuboid(0.0F, -4.0F, 0.0F, 4.0F, 4.0F, 4.0F, 0.0F, false);

		bone3 = new ModelPart(this);
		bone3.setPivot(1.5F, -4.0F, 1.5F);
		bone2.addChild(bone3);
		setRotationAngle(bone3, -0.2618F, 0.0F, 0.1047F);
		bone3.setTextureOffset(0, 95).addCuboid(0.0F, -2.0F, 0.0F, 1.0F, 2.0F, 1.0F, 0.0F, false);
}
